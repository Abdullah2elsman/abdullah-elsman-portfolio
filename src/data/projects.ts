...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "GitHub integration",
      "Docker responsibility shared with one teammate",
      "Backend integration with the AI service",
      "Selected technical and architectural decisions",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Improved backend data retrieval and added pagination",
      "Normalized poorly structured database areas",
      "Improved API response shapes and dashboard data flow",
      "Handled server troubleshooting and deployment",
      "Approximately 12,000 registered accounts",
    ],
    tags: ["Laravel", "React", "MySQL", "Linux / Server"],
    tier: 1,
